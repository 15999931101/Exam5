...
<div class="container" style="">
		<div  class="header" style="padding:0px;font-style: normal ;color:#473299;height: 60px;position:relative;">
			...
			<div style="position: absolute;right:10px;">用户：<%=session.getAttribute("admin") %></div> 
		</div>
		...
		<table border="1" cellpadding="5" cellspacing="0" bgcolor="silver"
			...
			<tr style="">
				<td>Customer_id</td>
				<td width="300" ><input type="text" name="customer_id" value="<%=request.getParameter("customer_id") %>" readonly="readonly">不可修改</td>
			</tr>
			<tr>
				<td>firt_name</td>
				<td width="300"><input type="text" name="first_name" value="<%=request.getParameter("first_name") %>"></td>
			</tr>
			<tr>
				<td>last_name</td>
				<td width="300"><input type="text" name="last_name" value="<%=request.getParameter("last_name") %>"></td>
			</tr>
			<tr >
				<td>email</td>
				<td width="300"><input type="text" name="email" value="<%=request.getParameter("email") %>"></td>
				
			</tr>
			<tr >
				<td>address</td>
				<td width="300"><input type="text" name="address" value="<%=request.getParameter("address") %>"></td>
				
			</tr>
			<tr >
				<td>last_update</td>
				<td width="300"><input type="text" name="last_update" value="<%=request.getParameter("last_update") %>"></td>
